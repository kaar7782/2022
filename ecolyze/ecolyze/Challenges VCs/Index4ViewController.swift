...
class Index4ViewController: UIViewController {
    ...
    func labelUpdate() {
        ...
        if Singleton.sharedInstance.numLabel == nil {
            ...
            Singleton.sharedInstance.numLabel = "\(Singleton.sharedInstance.index4)"
            ...
            let numberToAdd = Singleton.sharedInstance.index4
    ...
    private func createLayer() {
        ...
        /**https://www.youtube.com/watch?v=YosPD7eFvcE&list=PLz04aM26hOXkY4otTpaNO6u_o7Lx5T4bi&index=20**/
    }
