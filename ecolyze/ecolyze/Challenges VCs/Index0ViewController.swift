...
class Index0ViewController: UIViewController {
    ...
    func labelUpdate() {
        ...
        if Singleton.sharedInstance.numLabel == nil {
            ...
            let numberToAdd = Singleton.sharedInstance.index0
    ...
    /* https://stackoverflow.com/questions/34642369/swift-using-a-singleton-to-share-variables-not-passing-over */ //singleton information
    
    /*https://stackoverflow.com/questions/34553439/how-to-make-sum-in-one-label-swift
     adding and converting strings to integers */
}
