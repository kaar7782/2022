...
class ResourcesViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    let myData = ["Simple Tips to Live a More Sustainable Lifestyle", "How People Make Only a Jar of Trash a Year", "Zero Waste Living", "How to Reduce Your Carbon Footprint", "The World's Most Polluting Brands"]
  
    var myImages = [UIImage(named: "1"), UIImage(named: "2"),UIImage(named: "3"),UIImage(named: "4"), UIImage(named: "5")]
